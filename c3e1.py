...
#En este ejercicio hacemos una muestra de una funcion

def calAerea(b, h):    	#definimos la funcion y que le podemos enviar dos variables como argumento
	area = b * h 		#hacemos el calculo del area
	return area 		#regresamos el valor del area

print calAerea(2, 2) 	#imprimos el valor de regreso cuando la base mide 2 y la altura mide dos
