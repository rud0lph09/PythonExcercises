...
def dibujaSqr(tortuga):						#definimos la funcion para dibujar un cuadrado
	for i in range(4):						#ciclo for para repetir un loop 4 veces
		bk(tortuga, 100); rt(tortuga)		#usamos funcion atras y derecha para ir moviendo a la tortuga

dibujaSqr(monzi)							#llamamos la funcion para poder dibujar el cuadrado
